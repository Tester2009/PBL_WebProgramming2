...
if (isset($_POST['update'])) {
  ...
  $members = $connection->real_escape_string($members);
  $sql_update = "UPDATE Members SET text_value='$members' WHERE id='1'";
  $result = $connection->query($sql_update);
  if ($result) {
    // now refresh
    echo "<meta http-equiv='refresh' content='2; URL=./man_members.php'>";
    // echo "Updated";
    $text_data = "Updated. Refreshing...";
  }
  else {
    echo "ERROR ON UPDATING MEMBERS. <br />";
  }
}
else {
  // show.
...
<html lang="en">
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="man_members.php">Members</a></li>
  ...
  <div class="container">
    ...
    <div class="page-header">
      <h1>Manage your <u>Members</u> here</h1>
    </div>

    <form method="post" action="man_members.php">
      <textarea class="form-control" rows="15" autofocus name="Members"><?php echo $text_data; ?></textarea>
      <br />
